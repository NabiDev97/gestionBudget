        ...
        <div id="main-container">
             ...
             <div id="entete">
              ...
              <div id='pageAjoutTitle'>
                <h4 class='pageAjout'>Ajouter Depense</h4>
              </diV>

              <div class='formulaire'>
                    <form method="post" >
                        <h3>Titre</h3>
                        <input type="text" name='titre' placeholder='Electricite'>
                        <h3>Montant</h3>
                        <input type="number" id='montant'  name="montant" placeholder='50 000'>
                        <br>
